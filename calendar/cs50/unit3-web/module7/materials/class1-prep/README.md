...
Watch | Short | <a href="https://www.youtube.com/watch?v=WSKc1a25R6o&index=32&list=PLhQjrBD2T380dhmG9KMjsOQogweyjEeVQ" target="_blank">PHP Web Development</a> | Tommy Macwilliam talks about how we can mix HTML into our PHP code.
...
Do | Exercise | [Hello 1](../exercises/hello1) | TODO exc: reject forms that left name field blank. (Maybe add another condition too)
...
Do | Exercise | [Hello 2](../exercises/hello2) | TODO exc: provide helpful message if form was filled out incorrectly
