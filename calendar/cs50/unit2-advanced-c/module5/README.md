...
Study | CS50 Study | [pointers, malloc, linked lists, hash tables, tries, trees, stacks, queues](https://study.cs50.net/?toc=pointers,malloc,linked_lists,hashtables,tries,trees,stacks,queues) | malloc is good, do sooner rather than later
