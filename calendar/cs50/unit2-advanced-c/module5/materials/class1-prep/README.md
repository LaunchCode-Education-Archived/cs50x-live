...
Read | Resource | Recursive Structs | Here we provide a brief review of `struct`s, and then introduce the concept of a "recursively defined" `struct`. This is the curcial leap that allows us to create data structures such as linked lists, which you will learn about next.
