...
Task | Resource Type | Link | Instructions
-----|------|------|------
Watch | Lecture | <a href="https://youtu.be/uYiVtZHns-A?t=1542" target="_blank">Week 4 / Continued</a> | Just watch the second half. We will do the first half later, in Class 2 Prep.
