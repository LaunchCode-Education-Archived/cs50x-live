...
Do | Exercise | [Pointer Practice](../exercises/pointer-practice) | Use the given pointers to evaluate various statements.
...
Follow-Along | Walkthrough | <a href="https://www.youtube.com/watch?v=jE_bs-QNj3c&index=2&list=PLhQjrBD2T382SQnebs5bf6BkngrHTbJKg" target="_blank">copy-0</a> | Follow along with David as he tries (but fails) to copy one string into another. <br>Find instructions to start the follow-along <a href="../../../../../../helpful-resources/modules/module-4.html#class-1-task-copy-0" target="_blank">here</a>. 
