...
Read | Resource | [Creating Functions](../resources/our-own-functions) | This resource explains how, in addition to using other people's functions like `printf` and `round`, we can also write and use our own functions. 
