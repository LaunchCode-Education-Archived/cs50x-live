...
Watch | Doug's Playlist | <a href="https://www.youtube.com/watch?v=_FC-8QaaYgs&list=PLhQjrBD2T38117CFyiIB9x4NOR6979YwA&index=3" target="_blank">Operators</a> | Watch Doug's video about operators. There's a fair amount of text on the screen, so you may want to take notes if you find that helpful. <br> You can also check out the Operators section of the C Language cheat sheet in the CS50x Wiki <a href="../../../../../../helpful-resources/Supplementary-Resources/c-language.html#operators" target="_blank">here</a>.
