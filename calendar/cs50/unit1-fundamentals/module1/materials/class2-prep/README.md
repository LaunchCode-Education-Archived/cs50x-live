...
Read | Resource | [For vs While](../resources/for-vs-while/forvswhile) | Here we briefly illustrate how `for` loops and `while` loops truly are just different syntaxes for accomplishing the same thing.
