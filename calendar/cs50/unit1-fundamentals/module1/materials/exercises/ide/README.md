...
#### Logging In
In order to use the IDE, you will need an edX account. If you have not already registered on edX, <a href="https://courses.edx.org/register" target="_blank">go do that</a> now.

Head to <a href="https://cs50.io" target="_blank">cs50.io</a> and log into CS50 IDE by using your edX username and password. Upon logging in for the very first time, you should be informed that CS50 IDE (aka Cloud9, the software that underlies CS50 IDE) is "creating your workspace" and "creating your container," which might take a moment. (If you already have an account at c9.io, which is Cloud9’s own site, drop sysadmins@cs50.harvard.edu a note, and they will let you know how to "link" that account.)
