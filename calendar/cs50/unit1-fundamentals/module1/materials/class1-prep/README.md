...
Read | Supplementary Resource | [String Format Codes Cheatsheet](https://github.com/Launch-Code/cs50x-live-2016/wiki/C-Language#format-codes) | Check out this cheatsheet of the most common string format codes for inserting values into a string, e.g. `%s`, `%f` etc. For now, just pay attention to the "Format Codes" section. 
***
...
Do | Exercise | [Exercise: Marathon](../exercises/pemdas) |  Fix a program that tells the user how much more time they have to run in a marathon. It's mostly written already, with a key bug.
