...
Read | Supplementary Resource | [String Format Codes Cheatsheet](https://github.com/Launch-Code/cs50x-live-2016/wiki/C-Language#format-codes) | Check out this cheatsheet of the most common string format codes for inserting values into a string, e.g. `%s`, `%f` etc.
