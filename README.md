...
\* You can also check out the [CS50x Wiki](../../wiki) for additional resources and important links for the course by clicking the **`wiki`** tab underneath the repo name (LaunchCode/cs50x-live-2016) at the top of any page. 
