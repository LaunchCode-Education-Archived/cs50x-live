...
| Associative Arrays | `$array = [`<br>&nbsp;&nbsp;&nbsp;&nbsp;`key1 => value 1,`<br>&nbsp;&nbsp;&nbsp;&nbsp;`key2 => value2,`<br>&nbsp;&nbsp;&nbsp;&nbsp;`key3 => value3`<br>`];` | You can specify array indices with workds or phrases (_keys_), instead of integers, unlike `C`. [Example](#associative-arrays) |
